...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SwirepayApi.WebhookResponse();
  });
  ...
  describe('WebhookResponse', function() {
    it('should create an instance of WebhookResponse', function() {
      ...
      //var instane = new SwirepayApi.WebhookResponse();
      //expect(instance).to.be.a(SwirepayApi.WebhookResponse);
    });

    it('should have the property message (base name: "message")', function() {
      // uncomment below and update the code to test the property message
      //var instance = new SwirepayApi.WebhookResponse();
