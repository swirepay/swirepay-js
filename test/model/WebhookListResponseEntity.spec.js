...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SwirepayApi.WebhookListResponseEntity();
  });
  ...
  describe('WebhookListResponseEntity', function() {
    it('should create an instance of WebhookListResponseEntity', function() {
      // uncomment below and update the code to test WebhookListResponseEntity
      //var instane = new SwirepayApi.WebhookListResponseEntity();
      //expect(instance).to.be.a(SwirepayApi.WebhookListResponseEntity);
    });

    it('should have the property empty (base name: "empty")', function() {
      // uncomment below and update the code to test the property empty
      //var instance = new SwirepayApi.WebhookListResponseEntity();
