...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SwirepayApi.BalanceResponse();
  });
  ...
  describe('BalanceResponse', function() {
    it('should create an instance of BalanceResponse', function() {
      ...
      //var instane = new SwirepayApi.BalanceResponse();
      //expect(instance).to.be.a(SwirepayApi.BalanceResponse);
    });

    it('should have the property message (base name: "message")', function() {
      // uncomment below and update the code to test the property message
      //var instance = new SwirepayApi.BalanceResponse();
