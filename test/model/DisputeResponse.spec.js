...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SwirepayApi.DisputeResponse();
  });
  ...
  describe('DisputeResponse', function() {
    it('should create an instance of DisputeResponse', function() {
      ...
      //var instane = new SwirepayApi.DisputeResponse();
      //expect(instance).to.be.a(SwirepayApi.DisputeResponse);
    });

    it('should have the property message (base name: "message")', function() {
      // uncomment below and update the code to test the property message
      //var instance = new SwirepayApi.DisputeResponse();
