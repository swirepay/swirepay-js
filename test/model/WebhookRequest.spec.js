...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SwirepayApi.WebhookRequest();
  });
  ...
  describe('WebhookRequest', function() {
    it('should create an instance of WebhookRequest', function() {
      ...
      //var instane = new SwirepayApi.WebhookRequest();
      //expect(instance).to.be.a(SwirepayApi.WebhookRequest);
    });

    it('should have the property email (base name: "email")', function() {
      // uncomment below and update the code to test the property email
      //var instance = new SwirepayApi.WebhookRequest();
