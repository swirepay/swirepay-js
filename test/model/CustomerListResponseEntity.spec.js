...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SwirepayApi.CustomerListResponseEntity();
  });
  ...
  describe('CustomerListResponseEntity', function() {
    it('should create an instance of CustomerListResponseEntity', function() {
      // uncomment below and update the code to test CustomerListResponseEntity
      //var instane = new SwirepayApi.CustomerListResponseEntity();
      //expect(instance).to.be.a(SwirepayApi.CustomerListResponseEntity);
    });

    it('should have the property empty (base name: "empty")', function() {
      // uncomment below and update the code to test the property empty
      //var instance = new SwirepayApi.CustomerListResponseEntity();
