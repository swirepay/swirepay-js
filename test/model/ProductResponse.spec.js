...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SwirepayApi.ProductResponse();
  });
  ...
  describe('ProductResponse', function() {
    it('should create an instance of ProductResponse', function() {
      ...
      //var instane = new SwirepayApi.ProductResponse();
      //expect(instance).to.be.a(SwirepayApi.ProductResponse);
    });

    it('should have the property message (base name: "message")', function() {
      // uncomment below and update the code to test the property message
      //var instance = new SwirepayApi.ProductResponse();
