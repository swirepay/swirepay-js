...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SwirepayApi.EventResponse();
  });
  ...
  describe('EventResponse', function() {
    it('should create an instance of EventResponse', function() {
      ...
      //var instane = new SwirepayApi.EventResponse();
      //expect(instance).to.be.a(SwirepayApi.EventResponse);
    });

    it('should have the property message (base name: "message")', function() {
      // uncomment below and update the code to test the property message
      //var instance = new SwirepayApi.EventResponse();
