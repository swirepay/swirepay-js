...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SwirepayApi.CountryResponse();
  });
  ...
  describe('CountryResponse', function() {
    it('should create an instance of CountryResponse', function() {
      ...
      //var instane = new SwirepayApi.CountryResponse();
      //expect(instance).to.be.a(SwirepayApi.CountryResponse);
    });

    it('should have the property message (base name: "message")', function() {
      // uncomment below and update the code to test the property message
      //var instance = new SwirepayApi.CountryResponse();
