...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SwirepayApi.PaymentSessionListResponseEntity();
  });
  ...
  describe('PaymentSessionListResponseEntity', function() {
    it('should create an instance of PaymentSessionListResponseEntity', function() {
      // uncomment below and update the code to test PaymentSessionListResponseEntity
      //var instane = new SwirepayApi.PaymentSessionListResponseEntity();
      //expect(instance).to.be.a(SwirepayApi.PaymentSessionListResponseEntity);
    });

    it('should have the property empty (base name: "empty")', function() {
      // uncomment below and update the code to test the property empty
      //var instance = new SwirepayApi.PaymentSessionListResponseEntity();
