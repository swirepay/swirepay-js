...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SwirepayApi.SubscriptionListResponseEntity();
  });
  ...
  describe('SubscriptionListResponseEntity', function() {
    it('should create an instance of SubscriptionListResponseEntity', function() {
      // uncomment below and update the code to test SubscriptionListResponseEntity
      //var instane = new SwirepayApi.SubscriptionListResponseEntity();
      //expect(instance).to.be.a(SwirepayApi.SubscriptionListResponseEntity);
    });

    it('should have the property empty (base name: "empty")', function() {
      // uncomment below and update the code to test the property empty
      //var instance = new SwirepayApi.SubscriptionListResponseEntity();
