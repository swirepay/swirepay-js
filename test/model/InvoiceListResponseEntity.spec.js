...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SwirepayApi.InvoiceListResponseEntity();
  });
  ...
  describe('InvoiceListResponseEntity', function() {
    it('should create an instance of InvoiceListResponseEntity', function() {
      // uncomment below and update the code to test InvoiceListResponseEntity
      //var instane = new SwirepayApi.InvoiceListResponseEntity();
      //expect(instance).to.be.a(SwirepayApi.InvoiceListResponseEntity);
    });

    it('should have the property empty (base name: "empty")', function() {
      // uncomment below and update the code to test the property empty
      //var instance = new SwirepayApi.InvoiceListResponseEntity();
