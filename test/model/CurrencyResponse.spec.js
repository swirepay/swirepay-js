...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SwirepayPaymentApi.CurrencyResponse();
  });
  ...
  describe('CurrencyResponse', function() {
    it('should create an instance of CurrencyResponse', function() {
      ...
      //var instane = new SwirepayPaymentApi.CurrencyResponse();
      //expect(instance).to.be.a(SwirepayPaymentApi.CurrencyResponse);
    });

    it('should have the property message (base name: "message")', function() {
      // uncomment below and update the code to test the property message
      //var instance = new SwirepayPaymentApi.CurrencyResponse();
