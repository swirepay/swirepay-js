...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SwirepayApi.ReminderResponse();
  });
  ...
  describe('ReminderResponse', function() {
    it('should create an instance of ReminderResponse', function() {
      ...
      //var instane = new SwirepayApi.ReminderResponse();
      //expect(instance).to.be.a(SwirepayApi.ReminderResponse);
    });

    it('should have the property message (base name: "message")', function() {
      // uncomment below and update the code to test the property message
      //var instance = new SwirepayApi.ReminderResponse();
