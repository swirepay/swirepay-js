...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SwirepayApi.SecretKeyListResponseEntity();
  });
  ...
  describe('SecretKeyListResponseEntity', function() {
    it('should create an instance of SecretKeyListResponseEntity', function() {
      // uncomment below and update the code to test SecretKeyListResponseEntity
      //var instane = new SwirepayApi.SecretKeyListResponseEntity();
      //expect(instance).to.be.a(SwirepayApi.SecretKeyListResponseEntity);
    });

    it('should have the property empty (base name: "empty")', function() {
      // uncomment below and update the code to test the property empty
      //var instance = new SwirepayApi.SecretKeyListResponseEntity();
