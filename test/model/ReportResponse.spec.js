...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SwirepayPaymentApi.ReportResponse();
  });
  ...
  describe('ReportResponse', function() {
    it('should create an instance of ReportResponse', function() {
      ...
      //var instane = new SwirepayPaymentApi.ReportResponse();
      //expect(instance).to.be.a(SwirepayPaymentApi.ReportResponse);
    });

    it('should have the property message (base name: "message")', function() {
      // uncomment below and update the code to test the property message
      //var instance = new SwirepayPaymentApi.ReportResponse();
