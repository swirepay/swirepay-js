...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SwirepayApi.TransactionListResponseEntity();
  });
  ...
  describe('TransactionListResponseEntity', function() {
    it('should create an instance of TransactionListResponseEntity', function() {
      // uncomment below and update the code to test TransactionListResponseEntity
      //var instane = new SwirepayApi.TransactionListResponseEntity();
      //expect(instance).to.be.a(SwirepayApi.TransactionListResponseEntity);
    });

    it('should have the property empty (base name: "empty")', function() {
      // uncomment below and update the code to test the property empty
      //var instance = new SwirepayApi.TransactionListResponseEntity();
