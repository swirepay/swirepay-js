...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SwirepayApi.SubscriptionResponse();
  });
  ...
  describe('SubscriptionResponse', function() {
    it('should create an instance of SubscriptionResponse', function() {
      ...
      //var instane = new SwirepayApi.SubscriptionResponse();
      //expect(instance).to.be.a(SwirepayApi.SubscriptionResponse);
    });

    it('should have the property message (base name: "message")', function() {
      // uncomment below and update the code to test the property message
      //var instance = new SwirepayApi.SubscriptionResponse();
