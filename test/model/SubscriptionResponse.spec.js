...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SwirepayPaymentApi.SubscriptionResponse();
  });
  ...
  describe('SubscriptionResponse', function() {
    it('should create an instance of SubscriptionResponse', function() {
      ...
      //var instane = new SwirepayPaymentApi.SubscriptionResponse();
      //expect(instance).to.be.a(SwirepayPaymentApi.SubscriptionResponse);
    });

    it('should have the property message (base name: "message")', function() {
      // uncomment below and update the code to test the property message
      //var instance = new SwirepayPaymentApi.SubscriptionResponse();
