...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SwirepayApi.DisputeListResponseEntity();
  });
  ...
  describe('DisputeListResponseEntity', function() {
    it('should create an instance of DisputeListResponseEntity', function() {
      // uncomment below and update the code to test DisputeListResponseEntity
      //var instane = new SwirepayApi.DisputeListResponseEntity();
      //expect(instance).to.be.a(SwirepayApi.DisputeListResponseEntity);
    });

    it('should have the property empty (base name: "empty")', function() {
      // uncomment below and update the code to test the property empty
      //var instance = new SwirepayApi.DisputeListResponseEntity();
