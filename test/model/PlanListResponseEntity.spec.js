...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SwirepayApi.PlanListResponseEntity();
  });
  ...
  describe('PlanListResponseEntity', function() {
    it('should create an instance of PlanListResponseEntity', function() {
      // uncomment below and update the code to test PlanListResponseEntity
      //var instane = new SwirepayApi.PlanListResponseEntity();
      //expect(instance).to.be.a(SwirepayApi.PlanListResponseEntity);
    });

    it('should have the property empty (base name: "empty")', function() {
      // uncomment below and update the code to test the property empty
      //var instance = new SwirepayApi.PlanListResponseEntity();
