...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SwirepayPaymentApi.RefundResponse();
  });
  ...
  describe('RefundResponse', function() {
    it('should create an instance of RefundResponse', function() {
      ...
      //var instane = new SwirepayPaymentApi.RefundResponse();
      //expect(instance).to.be.a(SwirepayPaymentApi.RefundResponse);
    });

    it('should have the property message (base name: "message")', function() {
      // uncomment below and update the code to test the property message
      //var instance = new SwirepayPaymentApi.RefundResponse();
