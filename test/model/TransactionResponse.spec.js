...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SwirepayApi.TransactionResponse();
  });
  ...
  describe('TransactionResponse', function() {
    it('should create an instance of TransactionResponse', function() {
      ...
      //var instane = new SwirepayApi.TransactionResponse();
      //expect(instance).to.be.a(SwirepayApi.TransactionResponse);
    });

    it('should have the property message (base name: "message")', function() {
      // uncomment below and update the code to test the property message
      //var instance = new SwirepayApi.TransactionResponse();
