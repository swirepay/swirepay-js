...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SwirepayPaymentApi.UserResponse();
  });
  ...
  describe('UserResponse', function() {
    it('should create an instance of UserResponse', function() {
      ...
      //var instane = new SwirepayPaymentApi.UserResponse();
      //expect(instance).to.be.a(SwirepayPaymentApi.UserResponse);
    });

    it('should have the property gid (base name: "gid")', function() {
      // uncomment below and update the code to test the property gid
      //var instance = new SwirepayPaymentApi.UserResponse();
