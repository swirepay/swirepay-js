...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SwirepayApi.InvoiceLink();
  });
  ...
  describe('InvoiceLink', function() {
    it('should create an instance of InvoiceLink', function() {
      ...
      //var instane = new SwirepayApi.InvoiceLink();
      //expect(instance).to.be.a(SwirepayApi.InvoiceLink);
    });

    it('should have the property gid (base name: "gid")', function() {
      // uncomment below and update the code to test the property gid
      //var instance = new SwirepayApi.InvoiceLink();
