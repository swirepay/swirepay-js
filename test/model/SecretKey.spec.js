...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SwirepayApi.SecretKey();
  });
  ...
  describe('SecretKey', function() {
    it('should create an instance of SecretKey', function() {
      // uncomment below and update the code to test SecretKey
      //var instane = new SwirepayApi.SecretKey();
      //expect(instance).to.be.a(SwirepayApi.SecretKey);
    });

    it('should have the property gid (base name: "gid")', function() {
      // uncomment below and update the code to test the property gid
      //var instance = new SwirepayApi.SecretKey();
    ...
    it('should have the property pendingExpiration (base name: "pendingExpiration")', function() {
      // uncomment below and update the code to test the property pendingExpiration
      //var instance = new SwirepayApi.SecretKey();
      //expect(instance).to.be();
    });
