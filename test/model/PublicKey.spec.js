...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SwirepayApi.PublicKey();
  });
  ...
  describe('PublicKey', function() {
    it('should create an instance of PublicKey', function() {
      ...
      //var instane = new SwirepayApi.PublicKey();
      //expect(instance).to.be.a(SwirepayApi.PublicKey);
    });

    it('should have the property gid (base name: "gid")', function() {
      // uncomment below and update the code to test the property gid
      //var instance = new SwirepayApi.PublicKey();
