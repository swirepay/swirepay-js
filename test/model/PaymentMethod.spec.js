...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SwirepayApi.PaymentMethod();
  });
  ...
  describe('PaymentMethod', function() {
    it('should create an instance of PaymentMethod', function() {
      ...
      //var instane = new SwirepayApi.PaymentMethod();
      //expect(instance).to.be.a(SwirepayApi.PaymentMethod);
    });

    it('should have the property gid (base name: "gid")', function() {
      // uncomment below and update the code to test the property gid
      //var instance = new SwirepayApi.PaymentMethod();
