...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SwirepayApi.PayoutResponse();
  });
  ...
  describe('PayoutResponse', function() {
    it('should create an instance of PayoutResponse', function() {
      ...
      //var instane = new SwirepayApi.PayoutResponse();
      //expect(instance).to.be.a(SwirepayApi.PayoutResponse);
    });

    it('should have the property message (base name: "message")', function() {
      // uncomment below and update the code to test the property message
      //var instance = new SwirepayApi.PayoutResponse();
