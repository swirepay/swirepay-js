...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SwirepayApi.RefundListResponseEntity();
  });
  ...
  describe('RefundListResponseEntity', function() {
    it('should create an instance of RefundListResponseEntity', function() {
      // uncomment below and update the code to test RefundListResponseEntity
      //var instane = new SwirepayApi.RefundListResponseEntity();
      //expect(instance).to.be.a(SwirepayApi.RefundListResponseEntity);
    });

    it('should have the property empty (base name: "empty")', function() {
      // uncomment below and update the code to test the property empty
      //var instance = new SwirepayApi.RefundListResponseEntity();
