...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SwirepayApi.PlanResponse();
  });
  ...
  describe('PlanResponse', function() {
    it('should create an instance of PlanResponse', function() {
      ...
      //var instane = new SwirepayApi.PlanResponse();
      //expect(instance).to.be.a(SwirepayApi.PlanResponse);
    });

    it('should have the property message (base name: "message")', function() {
      // uncomment below and update the code to test the property message
      //var instance = new SwirepayApi.PlanResponse();
