...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SwirepayApi.PublicKeyListResponseEntity();
  });
  ...
  describe('PublicKeyListResponseEntity', function() {
    it('should create an instance of PublicKeyListResponseEntity', function() {
      // uncomment below and update the code to test PublicKeyListResponseEntity
      //var instane = new SwirepayApi.PublicKeyListResponseEntity();
      //expect(instance).to.be.a(SwirepayApi.PublicKeyListResponseEntity);
    });

    it('should have the property empty (base name: "empty")', function() {
      // uncomment below and update the code to test the property empty
      //var instance = new SwirepayApi.PublicKeyListResponseEntity();
