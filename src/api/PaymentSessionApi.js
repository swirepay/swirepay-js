...
export default class PaymentSessionApi {
    ...
    */
     ...
     */
    addPaymentSession(paymentSessionRequest, opts, callback) {
      opts = opts || {};
     ...
     * data is of type: {@link module:model/PaymentSessionResponse}
     */
    cancelPaymentSession(gid, opts, callback) {
      opts = opts || {};
      let postBody = null;
     ...
     * data is of type: {@link module:model/PaymentSessionResponse}
     */
    capturePaymentSession(gid, opts, callback) {
      opts = opts || {};
      let postBody = null;
      // verify the required parameter 'gid' is set
      if (gid === undefined || gid === null) {
     ...
     * data is of type: {@link module:model/PaymentSessionResponse}
     */
    getPaymentSessionByGid(gid, opts, callback) {
      opts = opts || {};
      let postBody = null;
      // verify the required parameter 'gid' is set
      if (gid === undefined || gid === null) {
